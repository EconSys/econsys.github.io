define(function(){
    ...
    props: ['bars','max','min','colors'],

    template: '<div class="data-bars" v-for="(index, item) in bar_styles" track-by="$index">' + 
                '<div class="label" v-bind:style="label_styles[index]">{{bar_values[index] | d3-formatter ",.1f"}}</div>' + 
